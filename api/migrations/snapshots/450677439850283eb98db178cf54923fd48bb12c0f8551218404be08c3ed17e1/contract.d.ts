...
export type StorageHash =
  StorageHashBase<'450677439850283eb98db178cf54923fd48bb12c0f8551218404be08c3ed17e1'>;
...
export declare const models: {
  public: {
    ...
    Statement: Models.public_Statement;
  };
};
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly statement: {
              ...
              uniques: readonly [{ readonly columns: readonly ['walletId'] }];
              indexes: readonly [];
              foreignKeys: readonly [];
            };
          };
...
> & {
  ...
  readonly roots: {
    ...
    readonly statement: { readonly namespace: 'public' & NamespaceId; readonly model: 'Statement' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
